...
const zhTW: LANG_MESSAGE = {
  ...
  darkTheme: '深色主題',
  proxyProvider: '代理提供商',
  pauseProvider: '暫停 Provider 自動維護',
  restoreProvider: '恢復 Provider 自動維護',
  providerOverride: 'Provider 覆寫',
  addProviderOverride: '新增 Provider',
  editProviderOverride: '編輯 Provider 覆寫',
  providerName: 'Provider 名稱',
  providerType: 'Provider 類型',
  providerPath: '本機檔案路徑',
  providerHeaders: '訂閱請求標頭 JSON（留空保留）',
  providerHeadersInvalid: '請求標頭必須是 JSON 物件',
  providerUrl: '訂閱位址',
  providerSecretPreserved: '已設定；留空將保留現有密鑰位址',
  updateInterval: '更新週期',
  attachProviderGroups: '植入策略組',
  providerOverrideRestartHint: '儲存前會校驗合併設定，然後重新啟動核心；現有連線可能短暫重連。',
  restoreOriginalProvider: '清除覆寫',
  restoreOriginalProviderConfirm: '清除這個覆寫並恢復原始 Provider 定義？',
  deleteProvider: '停用 Provider',
  deleteProviderConfirm: '停用 Provider {name}？現有節點保持可用，之後可在這裡恢復。',
  providerPausedHint: '自動更新和定時健康檢查已暫停，現有節點仍可繼續使用。',
  ruleProvider: '規則提供商',
  expire: '到期時間',
  noExpire: '不限時',
  updated: '更新於',
  ...
  startCore: '啟動核心',
  stopCore: '停止核心',
  startCoreSuccess: '已成功請求啟動核心',
  stopCoreSuccess: '核心已停止',
  stopCoreConfirm: '代理服務將不可用，直到再次啟動核心。',
  controllerToken: '控制器權杖',
  controllerPort: '控制器連接埠',
  ...
  testFinishedResultTip: '{name}\n測試完成：{success} 個可用，{failed} 個失敗或逾時',
  testFailedTip: '{name}\n測速超時',
