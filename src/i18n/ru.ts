...
const ru: LANG_MESSAGE = {
  ...
  providerPausedHint:
    'Автообновление и плановые проверки приостановлены; текущие узлы остаются доступными.',
  ...
  protocolTips:
    'Вы подключаете HTTP-бэкенд из HTTPS-панели. Разрешите смешанный контент или разместите HTTP-версию панели самостоятельно в той же доверенной сети.',
  global: 'Глобальный',
  direct: 'Прямой',
  ...
  startCoreSuccess: 'Запуск ядра успешно запрошен',
