...
const zh: LANG_MESSAGE = {
  ...
  darkTheme: '深色主题',
  proxyProvider: '代理提供商',
  pauseProvider: '暂停 Provider 自动维护',
  restoreProvider: '恢复 Provider 自动维护',
  providerOverride: 'Provider 覆写',
  addProviderOverride: '新增 Provider',
  editProviderOverride: '编辑 Provider 覆写',
  providerName: 'Provider 名称',
  providerType: 'Provider 类型',
  providerPath: '本地文件路径',
  providerHeaders: '订阅请求头 JSON（留空保留）',
  providerHeadersInvalid: '请求头必须是 JSON 对象',
  providerUrl: '订阅地址',
  providerSecretPreserved: '已配置；留空将保留现有密钥地址',
  updateInterval: '更新周期',
  attachProviderGroups: '植入策略组',
  providerOverrideRestartHint: '保存前会校验合并配置，然后重启核心；现有连接可能短暂重连。',
  restoreOriginalProvider: '清除覆写',
  restoreOriginalProviderConfirm: '清除这个覆写并恢复原始 Provider 定义？',
  deleteProvider: '停用 Provider',
  deleteProviderConfirm: '停用 Provider {name}？现有节点保持可用，之后可在这里恢复。',
  providerPausedHint: '自动更新和定时健康检查已暂停，现有节点仍可继续使用。',
  ruleProvider: '规则提供商',
  expire: '到期时间',
  noExpire: '不限时',
  updated: '更新于',
  ...
  protocolTips:
    '您正在从 HTTPS 面板连接 HTTP 后端，这可能被浏览器拦截。请允许混合内容，或在同一可信网络中自行部署 HTTP 版面板。',
  global: '全局',
  direct: '直连',
  ...
  startCore: '启动核心',
  stopCore: '停止核心',
  startCoreSuccess: '已成功请求启动核心',
  stopCoreSuccess: '核心已停止',
  stopCoreConfirm: '代理服务将不可用，直到再次启动核心。',
  controllerToken: '控制器令牌',
