...
The project Pages build is published at:

- [Zashboard sing-box](https://luange.github.io/zashboard-singbox/)

## **Download**

You can download the zashboard files here:

All release builds retain sing-box native and Clash-compatible API support.
Download the UI and controller binaries from
[this project's releases](https://github.com/luange/zashboard-singbox/releases/latest).
...
```
docker run -d -p 80:80 ghcr.io/luange/zashboard-singbox:latest
```
